...
public class AddMyShiftOfferRequestEvent extends Event {

    private final ShiftOffer.Request request;

    public AddMyShiftOfferRequestEvent(final ShiftOffer.Request request){
        super(EventType.ADD_MY_SHIFT_OFFER_REQUEST);
