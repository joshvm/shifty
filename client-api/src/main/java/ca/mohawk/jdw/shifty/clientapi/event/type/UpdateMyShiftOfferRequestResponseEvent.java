...
public class UpdateMyShiftOfferRequestResponseEvent extends Event {

    private final ShiftOffer.Request request;
    private final RequestAnswer answer;

    public UpdateMyShiftOfferRequestResponseEvent(final ShiftOffer.Request request,
                                                  final RequestAnswer answer){
        super(EventType.UPDATE_MY_SHIFT_OFFER_REQUEST_RESPONSE);
