...
public class RemoveAvailableShiftEvent extends Event {

    private final ShiftOffer shift;

    public RemoveAvailableShiftEvent(final ShiftOffer shift){
        super(EventType.REMOVE_AVAILABLE_SHIFT);
        this.shift = shift;
    }

    public ShiftOffer shift(){
        return shift;
    }
}
